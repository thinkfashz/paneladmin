...
export default function DashboardAcademyModulePage() {
  return (
    <main className="mx-auto flex w-full max-w-7xl flex-col gap-6 p-4 md:p-6">
      <section className="rounded-2xl border bg-background p-5 shadow-sm">
        ...
        <p className="mt-2 max-w-3xl text-muted-foreground text-sm">
          Vista academy del template original.
        </p>
      </section>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <p className="text-muted-foreground text-sm">
            Lógica esperada: Cursos, contenido, alumnos, progreso y aprendizaje.
          </p>
          <p className="text-muted-foreground text-sm">
            Próximo paso: completar componentes, acciones, servicios y conexión de datos dentro de
            <code className="mx-1 rounded bg-muted px-1 py-0.5">src/fabrick/modules/dashboard-academy</code>.
          </p>
        </CardContent>
      </Card>
    </main>
