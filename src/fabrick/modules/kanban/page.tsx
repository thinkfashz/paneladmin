...
export default function KanbanModulePage() {
  return (
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <p className="text-muted-foreground text-sm">
            Lógica esperada: Tablero visual de tareas, etapas y procesos.
          </p>
          <p className="text-muted-foreground text-sm">
            Próximo paso: completar componentes, acciones, servicios y conexión de datos dentro de
            <code className="mx-1 rounded bg-muted px-1 py-0.5">src/fabrick/modules/kanban</code>.
          </p>
        </CardContent>
      </Card>
    </main>
